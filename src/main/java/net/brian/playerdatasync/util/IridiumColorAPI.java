...
import net.brian.playerdatasync.util.pattern.GradientPattern;
import net.brian.playerdatasync.util.pattern.Pattern;
import net.brian.playerdatasync.util.pattern.RainbowPattern;
import net.brian.playerdatasync.util.pattern.SolidPattern;
